                ...
                <div className="card" style={{width: "22rem"}}>
                    <img src={ownerDog4} className="card-img-top" style={{height: "22rem"}} alt="..."></img>
                        ...
                        <h5 className="card-title priceFont"><u>Drop Ins</u></h5>
                            <p className="card-text">Busy on some day adventures? We will drop in and check on your pet, let them out for a bathroom break and ensure they have food and water!</p>
