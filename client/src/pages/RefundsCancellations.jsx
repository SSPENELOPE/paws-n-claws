...
const RefundsCancellations = () => {
    return (
        ...
        <div className="contact">
          ...
          <ul>
            <li> <h3>We completely understand if things happen and you are unable to keep your appointment.
            You are welcome to cancel at any time.
             All we ask is that you provide a 24 hr notice so that we can accommodate other dogs. If you cancel with less than 24 hrs notice, you may be charged a cancellation fee with the card associated with your account.</h3></li>
             <li>
             ...
             <li>
             <h3> Failure to adhere to these guidelines repeatedly may result in termination of your account. This is to ensure service to all our beloved clients. </h3>
             </li>
             <li>
