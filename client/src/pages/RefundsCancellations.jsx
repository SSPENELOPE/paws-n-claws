...
const RefundsCancellations = () => {
    return (
        ...
        <div className="contact">
          ...
          <h1>Cancellations</h1>
          <h3> While we strive to give your dog the best possible care, we completely understand if you do have to cancel. 
           ...
           <h3> We will be more than willing to reschedule at a more appropriate time. We will do our best to search for alternatives to an outdoor walk, but we cannot guarantee it.
            Failure to adhere to these guidelines repeatedly may result in termination of your account. This is to ensure service to all our beloved clients. </h3>
            <h1>Refunds</h1>
            <h3> If you need to cancel and reschedule an appointment, that is totally ok! While we do not offer refunds, we do allow you to use the credit towards a future walk. This credit will be valid for 1 year after the original appointment and will be applied to your next walk. </h3>
